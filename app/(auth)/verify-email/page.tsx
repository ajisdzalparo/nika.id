    ...
    switch (status) {
          ...
          <>
            <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 0.2, type: "spring", stiffness: 200 }} className="flex justify-center mb-6">
              <div className="relative">
                <div className="p-6 rounded-full bg-gradient-to-br from-blue-50 to-purple-50 shadow-lg">
                  <IconLoader2 className="w-16 h-16 text-blue-500 animate-spin" strokeWidth={1.5} />
                </div>
                <div className="absolute inset-0 bg-gradient-to-br from-blue-400/20 to-purple-400/20 rounded-full blur-2xl animate-pulse" />
              </div>
            </motion.div>
        ...
        return (
          <>
            <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: "spring", stiffness: 200 }} className="flex justify-center mb-6">
              <div className="relative">
                <motion.div initial={{ rotate: 0 }} animate={{ rotate: 360 }} transition={{ duration: 0.6 }} className="p-6 rounded-full bg-gradient-to-br from-green-50 to-emerald-50 shadow-lg">
            ...
            <CardTitle className="text-3xl font-black text-center tracking-tight">
              Email <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-emerald-500">Terverifikasi!</span>
            </CardTitle>
            ...
            <Button onClick={() => router.push("/dashboard")} className="w-full h-12 mt-6 rounded-2xl bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 shadow-lg font-bold">
              Lanjut ke Dashboard
            </Button>
          </>
        );
      ...
      case "error":
        return (
          <>
            <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: "spring", stiffness: 200 }} className="flex justify-center mb-6">
              <div className="p-6 rounded-full bg-gradient-to-br from-red-50 to-pink-50 shadow-lg">
                <IconAlertCircle className="w-16 h-16 text-red-500" strokeWidth={1.5} />
              </div>
            </motion.div>

            <CardTitle className="text-3xl font-black text-center tracking-tight">
              Verifikasi <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-pink-500">Gagal</span>
            </CardTitle>
            ...
            <div className="flex flex-col gap-3 mt-6">
              <Button onClick={() => router.push("/register")} className="w-full h-12 rounded-2xl bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 shadow-lg font-bold">
                Daftar Ulang
              </Button>
    ...
    <div className="relative min-h-[80vh] flex items-center justify-center">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="w-full max-w-lg">
        <Card className="border-none shadow-2xl bg-white/90 backdrop-blur-xl overflow-hidden">
          <div className="h-1.5 bg-gradient-to-r from-pink-400 to-purple-500 w-full" />
